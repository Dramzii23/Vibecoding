...
export const metadata = {
  title: "Documentación",
  description: "Guía completa del boilerplate Vibecoding — mapeada al curso semana a semana.",
}
  ...
  return (
    <div className="min-w-0">
      ...
      <p className="mt-4 max-w-2xl text-lg leading-relaxed text-base-content/60 md:text-xl">
        Todo lo que necesitas para llevar tu idea a producto con Vibecoding, mapeado semana a semana
        del curso.
      </p>
