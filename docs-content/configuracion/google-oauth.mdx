...
Activa el login con Google en mi proyecto Vibecoding: pon features.googleAuth en true en web/config.js y verifica que la pantalla /login muestre el botón de "Entrar con Google". No cambies nada más.
</PromptBox>
